package com.reporte.service.exception;
...
public class ApiExceptionHandler {
	...
	public ResponseEntity<ErrorMessage> dataIntegrityViolationExceptionHandler(HttpServletRequest request, DataIntegrityViolationException exception)
	{
		errorMessage.setException(exception.getClass().getSimpleName());
		errorMessage.setMessage(exception.getMessage()+": " + exception.getRootCause().getMessage());
		errorMessage.setPath(request.getRequestURI());
